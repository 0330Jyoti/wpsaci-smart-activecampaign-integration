<?php
class WPSACI_Smart_ActiveCampaign_Activator
{
    public function activate() {
		...
		$sql = "CREATE TABLE IF NOT EXISTS $smart_activecampaign_report_table_name (
		...
		$sql = "CREATE TABLE IF NOT EXISTS $smart_activecampaign_field_mapping_table_name (
			id 					int(11) 		NOT NULL AUTO_INCREMENT,
			wp_module 			varchar(100) 	NOT NULL,
			wp_field 			varchar(100) 	NOT NULL,
			activecampaign_module 		varchar(100) 	NOT NULL,
			activecampaign_field 			varchar(100) 	NOT NULL,
