...
class Order_Listst extends WP_List_Table {
	/** Class constructor */
	...
	public function no_items() {
		echo esc_html__( 'No orders avaliable.', 'wpsaci-smart-activecampaign' );
	}
	...
	function get_columns() {
		$columns = [
			'ID'    	=> esc_html__( 'Order Id', 'wpsaci-smart-activecampaign' ),
