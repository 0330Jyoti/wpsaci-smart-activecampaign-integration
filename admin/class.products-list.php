...
class Product_Listst extends WP_List_Table {
	/** Class constructor */
	public function __construct() {
		parent::__construct( [
			'singular' => esc_html__( 'Order', 'wpsaci-smart-activecampaign' ), //singular name of the listed records
			'plural'   => esc_html__( 'Orders', 'wpsaci-smart-activecampaign' ), //plural name of the listed records
	...
	public function no_items() {
		echo esc_html__( 'No products avaliable.', 'wpsaci-smart-activecampaign' );
	}
	...
	function get_columns() {
		$columns = [
			'ID'    => esc_html__( 'Product Id', 'wpsaci-smart-activecampaign' ),
			'post_title'    => esc_html__( 'Product Name', 'wpsaci-smart-activecampaign' ),
			'meta_value'    => esc_html__( 'Sku', 'wpsaci-smart-activecampaign' ),
			'post_date'    => esc_html__( 'Create Time', 'wpsaci-smart-activecampaign' ),
